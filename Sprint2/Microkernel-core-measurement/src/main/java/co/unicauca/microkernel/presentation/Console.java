...
public class Console {
    ...
    private void handleDeliveryCostOption(){
        ...
        System.out.println("Diametro del item: ");
        double diameter = scanner.nextDouble();
    
        System.out.println("Altura del item: ");
        double height = scanner.nextDouble();
        
        Product selectedProduct = new Product(id, weight, diameter, height);
        ...
        try {
            ...
            if(medicion){
                ...
                System.out.println("La medicion indica que la lata esta defectuosa.");
            }
